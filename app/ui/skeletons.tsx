  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-center truncate rounded-xl bg-white dark:bg-gray-700 px-4 py-8">
        <div className="h-7 w-20 rounded-md bg-gray-200 dark:bg-gray-600" />
      </div>
    </div>
  );
}
    ...
    <tr className="w-full border-b border-gray-100 dark:border-gray-700 last-of-type:border-none [&:first-child>td:first-child]:rounded-tl-lg [&:first-child>td:last-child]:rounded-tr-lg [&:last-child>td:first-child]:rounded-bl-lg [&:last-child>td:last-child]:rounded-br-lg">
      ...
      <td className="whitespace-nowrap py-3 pl-6 pr-3">
        <div className="flex justify-end gap-3">
          <div className="h-[38px] w-[38px] rounded bg-gray-200 dark:bg-gray-600" />
          <div className="h-[38px] w-[38px] rounded bg-gray-200 dark:bg-gray-600" />
        </div>
      </td>
    </tr>
  ...
  return (
    <div className="mb-2 w-full rounded-md bg-white dark:bg-gray-700 p-4">
      <div className="flex items-center justify-between border-b border-gray-100 dark:border-gray-600 pb-8">
        <div className="flex items-center">
          ...
          <div className="min-w-0">
            ...
            <div className="mt-2 h-4 w-12 rounded bg-gray-200 dark:bg-gray-600" />
          </div>
        </div>
        <div className="h-6 w-16 rounded bg-gray-200 dark:bg-gray-600" />
      </div>
      <div className="flex w-full items-center justify-between pt-4">
        <div>
          <div className="h-6 w-24 rounded bg-gray-200 dark:bg-gray-600" />
          <div className="mt-2 h-4 w-32 rounded bg-gray-200 dark:bg-gray-600" />
        </div>
        <div className="flex justify-end gap-2">
          <div className="h-10 w-10 rounded bg-gray-200 dark:bg-gray-600" />
          <div className="h-10 w-10 rounded bg-gray-200 dark:bg-gray-600" />
        </div>
      </div>
    </div>
