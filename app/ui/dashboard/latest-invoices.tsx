...
export default async function LatestInvoices() {
  ...
  return (
    <div className="flex w-full flex-col md:col-span-4">
      <h2 className={`${lusitana.className} mb-4 text-xl md:text-2xl text-gray-900 dark:text-white`}>
        Latest Invoices
      </h2>
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="min-w-0">
                    <p className="truncate text-sm font-semibold md:text-base text-gray-900 dark:text-white">
                      {invoice.name}
                    </p>
                ...
                <p
                  className={`${lusitana.className} truncate text-sm font-medium md:text-base text-gray-900 dark:text-white`}
                >
                  {invoice.amount}
                </p>
              </div>
